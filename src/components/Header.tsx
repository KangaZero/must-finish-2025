          ...
          {display.location && (
            <Row s={{ hide: true }}>
              <HoverCard
                tabIndex={0}
                placement="bottom"
                trigger={<span style={{ cursor: "pointer" }}>Based in <b>{person.location}</b></span>}
              >
                <Column padding="20" gap="20" radius="l" minHeight={25} minWidth={25} maxWidth={100} background="page" border="neutral-alpha-weak">
                  <Row gap="20" fillWidth vertical="center">
                    <Avatar size={3} src="/trademarks/accenture-logo.svg" aria-description="Accenture logo" />
                    <Column gap="4">
